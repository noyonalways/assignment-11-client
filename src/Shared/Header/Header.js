        ...
        <header className='bg-white  py-3 shadow-sm sticky top-0 z-[9999]'>
            <div className="container mx-auto md:px-16 px-3 ">
                <nav className='flex items-center justify-between relative'>
                    ...
                    <ul className={`lg:flex h-screen lg:h-auto items-center lg:space-x-5 w-4/6 lg:w-auto -top-3 bg-red-400 lg:bg-transparent absolute lg:static duration-200 z-10  ${open ? ' md:-left-48 sm:-left-24 -left-16 shadow lg:shadow-none text-right'  : "-left-[100%]" }`}>
                        <li className=''>
