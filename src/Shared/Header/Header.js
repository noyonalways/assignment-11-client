...
const Header = () => {
    ...
    return (
        <header className='bg-white py-3 relative shadow-sm'>
            <div className="container mx-auto md:px-16 px-3">
                <nav className='flex items-center justify-between'>
                    ...
                    <ul className={`lg:flex h-screen lg:h-auto items-center lg:space-x-5 w-3/6 lg:w-auto top-0 bg-white lg:bg-transparent absolute lg:static duration-200 ${open ? 'left-0 shadow lg:shadow-none'  : "-left-[50%]" }`}>
                        <li className=''>
                    ...
                    <button onClick={() => setOpen(!open)} className="lg:hidden text-3xl z-30 ">
